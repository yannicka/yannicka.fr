...
var blocks = {
	...
	'#7f0037': { x: 0,  y: 16, w: 1, h: 1, collide: true  }, // panel
...
function draw() {
	...
	if (cspace <= 12) {
		window_dialog(0, 152, can.width, 24, 'ok');
	}

	switch (cspace) {
		case 0: launchText('Bonjour, appuie sur Espace pour continuer.'); break;
		case 1: launchText('Donc tu es ' + player.name + ', ravi de faire ta connaissance.'); break;
		case 2: launchText('Tu vas bien ?'); break;
		case 3: launchText('Content que tu ailles bien :)'); break;
		case 4: launchText('Comment ca tu n\'as rien dit ?'); break;
		case 5: launchText('Je parle seul ? Tu te fous de moi ?'); break;
		case 6: launchText('Oui ?! Oh le culot !'); break;
		case 7: launchText('Tu me rends triste :('); break;
		case 8: launchText('Je vais pleurer seul dans mon coin...'); break;
		case 9: launchText('Maintenant tu es triste aussi, AH AH !'); break;
		case 10: launchText('Alors que je suis juste un programme.'); break;
		case 11: launchText('NA NA NA NERE, LA HONTE, ADIEU !'); break;
		case 12: launchText('*Deconnexion*'); break;
		default: break;
	}
